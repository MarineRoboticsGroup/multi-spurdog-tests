...
- **Status**: **Hardcoded guess** (per code comment)
...
- **Status**: **Fixed constant**, not adaptive to conditions
...
Validation against surface GPS shows:
- GTSAM σ=2.0m → **3.25m error** (excellent)
- CORA σ=0.316m → **13.20m error** (good)

This confirms tuning is **empirically valid** for the system.
...
### Consider Adding Rotation Uncertainty

Rotation covariance is published as 0.0, but IMU gyros have noise. Consider:
